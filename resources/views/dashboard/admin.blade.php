    ...
    <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
        <main>
                            ...
                            <table class="table-fixed min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Angular
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#194556
                                        </td>
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">React JS
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#623232
                                        </td>
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#194356
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#323323
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#994856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#194256
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#623378
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#192856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#523323
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#191857
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#914856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#633293
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-924856" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#924856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-123323" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#123323
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-198856" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#198856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-132856" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#132856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-613223" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#613223
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-484856" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#484856
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-103324" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#103324
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        <td class="p-4 w-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-124859" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">#124859
                                        </td>
                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
            ...
            <div class="hidden overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full"
                id="product-modal" aria-hidden="true">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="product-name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Product Name</label>
