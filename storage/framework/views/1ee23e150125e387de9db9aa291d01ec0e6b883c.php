                ...
                <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                    ...
                    <div class="flex items-center sm:justify-end w-full">
                        ...
                        <button type="button" data-modal-toggle="add-product-modal"
                            ...
                            <a href="<?php echo e(route('dashboard.barang.add')); ?>" target=" _blank">Add product </a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal"
                                                onclick="location.href='/dashboard/barang/<?php echo e($elemen->id); ?>'"
...
<?php echo $__env->make('dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web\resources\views/dashboard/barang.blade.php ENDPATH**/ ?>