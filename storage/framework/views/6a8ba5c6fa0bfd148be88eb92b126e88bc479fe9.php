                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(route('dashboard.barang')); ?>"
                    ...
                    <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                        ...
                        <div class="bg-white rounded-lg shadow relative">
                            ...
                            <div class="p-6 space-y-6">
                                <form method="post" action="<?php echo e(route('barang.update')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('put'); ?>
                                    <input type="hidden" name="id" value="<?php echo e($barang->id); ?>" <div
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="name" id="name"
                                            ...
                                            placeholder="" required="" value="<?php echo e($barang->name); ?>">
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="price"
                                        ...
                                        <input type="number" name="price" id="price"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                            placeholder="" required="" value="<?php echo e($barang->price); ?>">
                                    </div>
                                    <div class="col-span-full">
                                        ...
                                        <textarea id="description" rows="6" name="description"
                                            ...
                                            value=""><?php echo e($barang->description); ?></textarea>
                                    </div>
                                    <div class="col-span-full">
                                        <div class="m-4">
                                            ...
                                            <img class="img-preview img-fluid mb-3 col-sm-5  object-contain	"
                                                src="<?php echo e(asset('images/' . $barang->file_path)); ?> ">
...
<?php echo $__env->make('dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web\resources\views/dashboard/barang/edit.blade.php ENDPATH**/ ?>