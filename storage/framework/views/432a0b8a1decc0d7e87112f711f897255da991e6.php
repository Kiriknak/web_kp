                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="" required="" value="<?php echo e($customer->nama); ?>" disabled>
                            </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <textarea id="alamat" rows="3" name="alamat" disabled
                                    ...
                                    placeholder=""><?php echo e($customer->alamat); ?></textarea>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="phone" id="phone" disabled
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="" required="" value="<?php echo e($customer->telepon); ?>">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" name="kodepos" id="kodepos" disabled
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="" required="" value="<?php echo e($customer->kodepos); ?>">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="kabupaten" id="kabupaten" disabled
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="" required="" value="<?php echo e($customer->kabupaten); ?>">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="state" id="state" disabled
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="" required="" value="<?php echo e($customer->provinsi); ?>">
                            </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex space-x-4 mt-4 ">
                                    <div>
                                        <img src="<?php echo e(asset('images/' . $barang->file_path)); ?>" alt="image"
                                            class="h-32 w-40 object-scale-down rounded-md	">
                                    </div>
                                    <div>
                                        <h2 class="text-xl font-bold"><?php echo e($barang->name); ?></h2>
                                        <span
                                            class=" text-xs"><?php echo e('Rp.' . $barang->price . ' x ' . $cartItem['qty']); ?></span><br>
                                        <span class=" text-xs">Rp. <?php echo e($barang->price * $cartItem['qty']); ?></span>
                                        <?php
                            ...
                            <form method="POST" action="<?php echo e(route('penjualan.place')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/penjualan/index.blade.php ENDPATH**/ ?>