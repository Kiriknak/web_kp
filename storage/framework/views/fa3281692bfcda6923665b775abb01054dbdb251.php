                    ...
                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                            <div class="md:w-4/12 2xl:w-1/4 w-full">
                                <img src="<?php echo e(asset('images/' . $barang->file_path)); ?>" alt=""
                            ...
                            <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                                <p class="text-xs leading-3 text-gray-800 md:pt-0 pt-4">#<?php echo e($barang->id); ?></p>
                                <div class="flex items-center justify-between w-full pt-1">
                                    <p class="text-base font-black leading-none text-gray-800"><?php echo e($barang->name); ?></p>
                                    ...
                                    <form action="<?php echo e(route('cart.update', $cartItem['id'])); ?>" method="POST">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <input type="number"
                                                ...
                                                name="qty" value="<?php echo e($cartItem['qty']); ?>"></input>
                                ...
                                <p class="text-base font-black leading-none text-gray-800">Rp.<?php echo e($barang->price); ?></p>
                                <?php
                ...
                <div
                    ...
                    <div>
                        <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                            ...
                            <p class="text-2xl font-bold leading-normal text-right text-gray-800">Rp.<?php echo e($sum); ?>

                            </p>
                        </div>
                        <button onclick="location.href='<?php echo e(route('penjualan.order')); ?> '"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/cart/index.blade.php ENDPATH**/ ?>