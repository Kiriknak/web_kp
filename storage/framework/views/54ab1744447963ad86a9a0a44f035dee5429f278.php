        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
            <div class="mb-1 w-full">
                ...
                <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
                    ...
                    <a href="<?php echo e(route('penjualan.create')); ?>" data-modal-toggle="add-product-modal"
                    ...
                    <div class="shadow overflow-hidden">
                        ...
                        <table class="table-fixed min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $penjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elemen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">
                                                <?php echo e($elemen->customer->nama); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo e($penjualan->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/dashboard/penjualan/index.blade.php ENDPATH**/ ?>