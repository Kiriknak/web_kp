                ...
                <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="w-full flex -mx-1 lg:-mx-4 flex-wrap ">
                            <a href="<?php echo e(route('items.show', $barang->id)); ?>">
                                <div class="place-self-center">
                                    <img class="rounded-t-lg object-contain h-64  mx-auto my-3 "
                                        src="<?php echo e(asset('images/' . $barang->file_path)); ?>" alt="">
                                </div>
                            </a>
                            <div class="p-5 mx-5 ">
                                <a href="<?php echo e(route('items.show', $barang->id)); ?>"
                                    class="mb-2 text-2xl font-bold tracking-tight text-gray-900 "><?php echo e($barang->name); ?></h5>
                                </a>
                                <p class="mb-3 font-normal text-gray-700 "><?php echo e($barang->description); ?></p>
                                <p class="mb-3 font-normal text-gray-700 ">Rp.<?php echo e($barang->price); ?></p>
                                <form action="<?php echo e(route('cart.add', $barang->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
